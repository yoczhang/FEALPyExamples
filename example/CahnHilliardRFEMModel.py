...
from fealpy.fem.doperator import mass_matrix, grad_recovery_matrix
import pyamg
...
class CahnHilliardRFEMModel():
    ...
    def get_stiff_matrix(self):
        ...
        K += self.pde.epsilon ** 2 * (
                    A.transpose() @ P @ A + A.transpose() @ Q @ B + B.transpose() @ Q @ A + B.transpose() @ S @ B)
        return K
