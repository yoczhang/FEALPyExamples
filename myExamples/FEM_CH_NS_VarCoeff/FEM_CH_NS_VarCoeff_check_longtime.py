...
# ---
# @Software: PyCharm
# @File: FEM_CH_NS_VarCoeff_check_longtime.py
...
# --- logging --- #
make_print_to_file(filename='FEM_CH_NS_VarCoeff_check_longtime', setpath="/Users/yczhang/Documents/FEALPy/FEALPyExamples/FEALPyExamples/myExamples/Logs/")
...
for i in range(N_T):
    ...
    print('i = ', i)
    print('# -------------------------------------------------- #')
    NN = int((box[1] - box[0])/h_space[i])  # TODO: NN = int(1./h_space[i]) ??
    mesh = MF.boxmesh2d(box, nx=NN, ny=NN, meshtype='tri')
