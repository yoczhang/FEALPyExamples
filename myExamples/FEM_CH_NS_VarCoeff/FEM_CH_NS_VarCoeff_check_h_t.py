...
# ---
# @Software: PyCharm
# @File: FEM_CH_NS_VarCoeff_check_h_t.py
...
# --- logging --- #
make_print_to_file(filename='FEM_CH_NS_VarCoeff_check_h_t', setpath="/Users/yczhang/Documents/FEALPy/FEALPyExamples/FEALPyExamples/myExamples/Logs/")
...
VarCoeff = {'rho0': 1e-0, 'rho1': 3e-0, 'nu0': 1e-2/2, 'nu1': 2e-2/2}
