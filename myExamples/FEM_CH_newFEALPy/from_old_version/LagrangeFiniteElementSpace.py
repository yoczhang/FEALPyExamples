...
# currt: fealpy.old.functionspace
# from ..decorator import barycentric
from fealpy.old.decorator import barycentric

# from .Function import Function
from fealpy.old.functionspace.Function import Function

# from .femdof import multi_index_matrix1d
from fealpy.old.functionspace.femdof import multi_index_matrix1d
# from .femdof import multi_index_matrix2d
from fealpy.old.functionspace.femdof import multi_index_matrix2d
# from .femdof import multi_index_matrix3d
from fealpy.old.functionspace.femdof import multi_index_matrix3d

# from .femdof import multi_index_matrix
from fealpy.old.functionspace.femdof import multi_index_matrix

# from .femdof import CPLFEMDof1d, CPLFEMDof2d, CPLFEMDof3d
from fealpy.old.functionspace.femdof import CPLFEMDof1d, CPLFEMDof2d, CPLFEMDof3d
# from .femdof import DPLFEMDof1d, DPLFEMDof2d, DPLFEMDof3d
from fealpy.old.functionspace.femdof import DPLFEMDof1d, DPLFEMDof2d, DPLFEMDof3d

# from ..quadrature import FEMeshIntegralAlg
from fealpy.old.quadrature import FEMeshIntegralAlg
# from ..decorator import timer
from fealpy.old.decorator import timer
    ...
    * 四面体网格(3d)
    ...
    def residual_estimate(self, uh, f=None, c=None):
        ...
        if c is not None:
            if isinstance(c, (int, float)):
                ...
                elif len(c.shape) == 2: # (NC, GD)
                    grad = np.einsum('im, im->im', c, grad)
                elif len(c.shape) == 3: # (NC, GD, GD)
    ...
    def linear_interpolation_matrix(self):
        ...
        if self.spacetype == 'C':
            ...
            P = csr_matrix((val.flat, (I.flat, J.flat)), shape=(gdof, NN),
                    dtype=self.ftype)
            return P
