...
# --- logging --- #
# make_print_to_file(filename='FEM_CH_NS_check_h', setpath="/Users/yczhang/Documents/FEALPy/FEALPyExamples/FEALPyExamples/myExamples/Logs/")
...
for i in range(N_T):
    ...
    print('i = ', i)
    print('# -------------------------------------------------- #')
    NN = int(1./h_space[i])  # TODO: NN = int(1./h_space[i]) + 1 ??
    mesh = MF.boxmesh2d(box, nx=NN, ny=NN, meshtype='tri')
    if time_scheme == 1:
