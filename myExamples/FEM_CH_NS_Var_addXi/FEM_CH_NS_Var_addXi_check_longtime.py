...
# ---
# @Software: PyCharm
# @File: FEM_CH_NS_Var_addXi_check_longtime.py
...
# --- logging --- #
# make_print_to_file(filename='FEM_CH_NS_Var_addXi_check_longtime', setpath="/Users/yczhang/Documents/FEALPy/FEALPyExamples/FEALPyExamples/myExamples/Logs/")
...
for i in range(N_T):
    ...
    mesh = MF.boxmesh2d(box, nx=NN, ny=NN, meshtype='tri')
    if time_scheme == 1:
        ch = FEM_CH_NS_Var_addXi_Model2d(pde, mesh, p, dt_space)
